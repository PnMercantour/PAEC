window.PNM = Object.assign({}, window.PNM, {
  PAEC: {
    ...
    upTooltip: (feature, layer) => {
      layer.bindTooltip(`unité pastorale<small> #${
        feature.properties.id
      }</small>
      <br><strong>${feature.properties.nom}</strong>
      <hr>
...
`);
    ...
    gestionTooltip: (feature, layer) => {
      layer.bindTooltip(`mesure de gestion<small> #${
        feature.properties.id
      } (MAEC #${feature.properties.maec})</small>
<br><strong>${
        PNM.PAEC.catalogue_mesures[feature.properties.type_mesure]
      }</strong>
<hr>
...
`);
    ...
    faucheTooltip: (feature, layer) => {
      layer.bindTooltip(`mesure de fauche<small> #${
        feature.properties.id
      }</small>
<br><strong>${
        PNM.PAEC.catalogue_mesures_fauche[feature.properties.engagement]
      }</strong>
<hr>
