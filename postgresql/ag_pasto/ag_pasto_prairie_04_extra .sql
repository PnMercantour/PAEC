-- Localisation des prairies 04 / limites réglementaires
CREATE MATERIALIZED VIEW paec.ag_pasto_prairie_04_extra TABLESPACE pg_default AS with geo as (
    select id,
        geom
...
create index on paec.ag_pasto_prairie_04_extra(id);