-- Localisation des unités pastorales / limites réglementaires
CREATE MATERIALIZED VIEW paec.ag_pasto_up_extra TABLESPACE pg_default AS with geo as (
    select id,
        geom
...
create index on paec.ag_pasto_up_extra(id);