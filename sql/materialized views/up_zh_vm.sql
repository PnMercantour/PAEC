-- paec.up_zh_vm source
CREATE MATERIALIZED VIEW paec.up_zh_vm TABLESPACE pg_default AS with geo as (
    select id,
        geom
...
-- View indexes:
CREATE INDEX ON paec.up_zh_vm USING btree (id);
-- Permissions
ALTER TABLE paec.up_zh_vm OWNER TO postgres;
GRANT ALL ON TABLE paec.up_zh_vm TO postgres;
grant select on table paec.up_zh_vm to consult_agpasto,
    consult_flore,
    pnm_consult;