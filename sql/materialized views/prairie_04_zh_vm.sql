-- paec.prairie_04_zh_vm source
CREATE MATERIALIZED VIEW paec.prairie_04_zh_vm TABLESPACE pg_default AS with geo as (
    select id,
        geom
...
-- View indexes:
CREATE INDEX ON paec.prairie_04_zh_vm USING btree (id);
-- Permissions
ALTER TABLE paec.prairie_04_zh_vm OWNER TO postgres;
GRANT ALL ON TABLE paec.prairie_04_zh_vm TO postgres;
grant select on table paec.prairie_04_zh_vm to consult_agpasto,
    consult_flore,
    pnm_consult;